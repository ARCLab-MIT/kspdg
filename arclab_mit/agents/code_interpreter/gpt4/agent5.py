...
class Agent(KSPDGBaseAgent):
    def __init__(self):
        ...
        self.damping_factor = 0.05  # Damping factor for throttle calculation
    ...
    def get_action(self, observation):
        ...
        # Dynamic throttle control based on distance and closure rate damping factor
        throttle = min(1.0, max(0.1, (1 - (distance / 5000) + 0.5 * closure_rate / distance) * (1 - self.damping_factor)))
