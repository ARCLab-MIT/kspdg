...
class ProportionalNavigationGuidanceAgent(KSPDGBaseAgent):
    ...
    def get_action(self, observation):
        ...
        if self.prev_target_position is not None:
            ...
            # Normalize the required acceleration
            normalized_required_acceleration = required_acceleration / np.linalg.norm(
                required_acceleration
            )
            ...
            if (
                ...
                throttle = 0.1
            print([*normalized_required_acceleration, throttle])
            return {
                "burn_vec": [*normalized_required_acceleration, throttle],
                "ref_frame": 0,
            }
